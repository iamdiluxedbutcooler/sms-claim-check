...
echo "  Cleaning data/annotations folder..."
cd data/annotations
...
echo "  Cleaning data/processed folder..."
...
echo "  Removing unused experiment folders..."
...
echo "  Removing duplicate model code..."
rm -rf src/models/
rm -rf src/data/
...
echo "  Removing configs folder..."
rm -rf configs/

# 10. Remove notebooks_backup (duplicates)
echo "  Removing notebook backups..."
